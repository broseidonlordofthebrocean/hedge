          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-4">
                ...
                <span
                  className={`px-3 py-1 rounded-full text-sm font-medium ${TIER_BG[stock.tier]} ${TIER_COLORS[stock.tier]}`}
                >
                  {stock.tier}
                </span>
              </div>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-charcoal-light border-charcoal-lighter">
            <CardHeader>
              <CardTitle className="text-white">Survival Meter</CardTitle>
            </CardHeader>
          ...
          <Card className="bg-charcoal-light border-charcoal-lighter">
            <CardHeader>
              <CardTitle className="text-white">Factor Analysis</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">{stock.scenarios.gradual}</span>
                </div>
                <div className="h-2 bg-charcoal rounded-full overflow-hidden">
                  <div
                    className="h-full bg-green-500 rounded-full"
                    style={{ width: `${stock.scenarios.gradual}%` }}
                  />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">{stock.scenarios.rapid}</span>
                </div>
                <div className="h-2 bg-charcoal rounded-full overflow-hidden">
                  <div
                    className="h-full bg-yellow-500 rounded-full"
                    style={{ width: `${stock.scenarios.rapid}%` }}
                  />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">{stock.scenarios.hyper}</span>
                </div>
                <div className="h-2 bg-charcoal rounded-full overflow-hidden">
                  <div
                    className="h-full bg-red-500 rounded-full"
                    style={{ width: `${stock.scenarios.hyper}%` }}
                  />
                </div>
              </div>
            </CardContent>
        ...
        <Card className="bg-charcoal-light border-charcoal-lighter">
          ...
          <CardContent>
            <ScoreHistory history={stock.history} />
          </CardContent>
        </Card>
        ...
        <Card className="bg-charcoal-light border-charcoal-lighter">
          <CardHeader>
            <CardTitle className="text-white">Factor Breakdown</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-charcoal-light border-charcoal-lighter">
          <CardHeader>
            <CardTitle className="text-white">Key Fundamentals</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div className="text-center p-4 bg-charcoal rounded-lg">
                ...
                <p className="text-xl font-semibold text-white">
                  {formatCurrency(stock.fundamentals.total_assets)}
                </p>
              </div>
              <div className="text-center p-4 bg-charcoal rounded-lg">
                <p className="text-sm text-gray-400">Total Debt</p>
                <p className="text-xl font-semibold text-white">
                  {formatCurrency(stock.fundamentals.total_debt)}
                </p>
              </div>
              <div className="text-center p-4 bg-charcoal rounded-lg">
                <p className="text-sm text-gray-400">Foreign Rev %</p>
                <p className="text-xl font-semibold text-white">
                  {stock.fundamentals.foreign_revenue_pct}%
                </p>
              </div>
              <div className="text-center p-4 bg-charcoal rounded-lg">
